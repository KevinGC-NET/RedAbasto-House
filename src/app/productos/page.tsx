...
import { Button, Input, Modal, Card, CardContent, Select, ImageUpload } from '@/components/ui'
...
export default function ProductosPage() {
  ...
  async function fetchData() {
    ...
    if (categoriasRes.error) console.error('Error fetching categorias:', categoriasRes.error)
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <p className="text-slate-400 text-sm sm:text-base">Gestiona tu inventario de productos (precios en USD)</p>
            ...
            <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {productos.map((producto) => (
                ...
                >
                  ...
                  {/* Info del producto */}
                  <div className="p-4">
                    <h3 className="font-semibold text-slate-100 truncate mb-1" title={producto.nombre}>
                      {producto.nombre}
                    </h3>
                    ...
                    {!producto.descripcion && <div className="mb-3 min-h-[2.5rem]" />}
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {producto.categoria ? (
                          ...
                          <span className="text-slate-500 text-sm">Sin categoría</span>
                        )}
                      </td>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div>
                          <p className="font-semibold text-slate-100">{formatearPrecio(producto.precio)}</p>
                          <p className="text-xs text-slate-500">$ {producto.precio.toFixed(2)} USD</p>
                        </div>
                        <span
                          className={`px-2 py-1 rounded-md text-sm ${
                            producto.stock > 10
